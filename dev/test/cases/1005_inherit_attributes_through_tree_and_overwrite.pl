...
#
# inherit a host and an service attribute through the main tree and overwrite them below
#
# tredel, 2011
#
...
$testresult->{description} = 'inherited host and service attributes will be overwritten?';
...
sub test {
	...
	my $result = initializeLDAP('1005_inherit_attributes_through_tree_and_overwrite.ldif');
